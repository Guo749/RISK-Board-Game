...
public class GameLoseControllerTest {
    App app;
    @Start
    public void start(Stage stage) throws Exception {
        ...
        new Thread(() -> {
            try {
                ServerSocket socket = new ServerSocket(57910);
        ...
        App.ps.show();
        App.player = new Player("127.0.0.1", 57910);

    }

   // @Test
    public void test_refresh(FxRobot robot){
