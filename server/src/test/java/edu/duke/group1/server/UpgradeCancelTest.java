...
public class UpgradeCancelTest {
    ...
    public void start(Stage stage) throws Exception {
        ...
        new Thread(() -> {
            try {
                edu.duke.group1.server.App.main(new String[]{"58143"});
            } catch (Exception e) {
                e.printStackTrace();
            }
        }).start();
        ...
        Player player = new Player("127.0.0.1", 58143);
    ...
    //@Test
    public void test_upgrade_server(FxRobot robot){
        try {
